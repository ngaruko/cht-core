...
const { UNIT_TEST_ENV, SERVICE } = process.env;
...
if (UNIT_TEST_ENV) {
  ...
  module.exports.serverUrl = environment.couchUrl.slice(0, environment.couchUrl.lastIndexOf('/'));
  ...
  module.exports.allDbs = () => rpn.get({ url: `${module.exports.serverUrl}/_all_dbs`, json: true });
